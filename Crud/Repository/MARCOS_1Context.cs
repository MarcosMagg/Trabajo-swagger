...
{
    public partial class MARCOS_1Context : DbContext
    {
        public MARCOS_1Context()
        {
        }

        public MARCOS_1Context(DbContextOptions<MARCOS_1Context> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Actore>(entity =>
            {
                entity.HasKey(e => e.IdActor)
                    .HasName("PK__Actores__F86BE717DA78F6CE");
            ...
            modelBuilder.Entity<Actuacione>(entity =>
            {
                entity.HasKey(e => e.IdActuacion)
                    .HasName("PK__Actuacio__9D268343CCAC0156");
            ...
            modelBuilder.Entity<Directore>(entity =>
            {
                entity.HasKey(e => e.IdDirector)
                    .HasName("PK__Director__6B65E2A2668C6403");
            ...
            modelBuilder.Entity<Genero>(entity =>
            {
                entity.HasKey(e => e.IdGenero)
                    .HasName("PK__Generos__99A8E4F98D04BCF0");
            ...
            modelBuilder.Entity<Pelicula>(entity =>
            {
                entity.HasKey(e => e.IdPelicula)
                    .HasName("PK__Pelicula__B5017F4DD7AE3894");
            ...
            modelBuilder.Entity<PeliculasGenero>(entity =>
            {
                entity.HasKey(e => e.IdPeliculaGenero)
                    .HasName("PK__Pelicula__021DFEC085518648");
            ...
            modelBuilder.Entity<Productora>(entity =>
            {
                entity.HasKey(e => e.IdProductora)
                    .HasName("PK__Producto__0E435047E2F2DA0A");
            ...
            modelBuilder.Entity<Ranking>(entity =>
            {
                entity.HasKey(e => e.IdRanking)
                    .HasName("PK__Rankings__200113997ED9D9B4");
